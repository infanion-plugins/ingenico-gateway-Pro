...
namespace ipcraft\ingenicogatewaypro\fields;

use ipcraft\ingenicogatewaypro\IngenicoGatewayPro;
use ipcraft\ingenicogatewaypro\assetbundles\ingenicogatewayprofieldfield\IngenicoGatewayProFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class IngenicoGatewayProField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('ingenico-gateway-pro', 'IngenicoGatewayProField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'ingenico-gateway-pro/_components/fields/IngenicoGatewayProField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(IngenicoGatewayProFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').IngenicoGatewayProIngenicoGatewayProField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'ingenico-gateway-pro/_components/fields/IngenicoGatewayProField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
